        ...
        <div class="row">
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat blue-madison">
                    ...
                    <div class="details">
                        <div class="number">
                        <?php 
                            $Jml_Pasien = count($TotalPasien);
                            echo number_format($Jml_Pasien);
                        ?>
                        </div>
                        <div class="desc">
                        Pasien
                    ...
                    <a class="more" href="<?php echo site_url('apotek/service'); ?>">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat red-intense">
                    ...
                    <a class="more" href="<?php echo site_url('apotek/project'); ?>">
                        View more <i class="m-icon-swapright m-icon-white"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat green-haze">
                    ...
                    <a class="more" href="<?php echo site_url('apotek/news'); ?>">
                        View more <i class="m-icon-swapright m-icon-white"></i>
                    </a>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="dashboard-stat purple-plum">
                    ...
                    <a class="more" href="<?php echo site_url('apotek/testimoni'); ?>">
                        View more <i class="m-icon-swapright m-icon-white"></i>
                    </a>
                </div>
            </div>
