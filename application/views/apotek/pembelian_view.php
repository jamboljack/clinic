                    ...
                    <div class="portlet-body">                        
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo site_url('apotek/pembelian/editdata/'.$r->pembelian_id); ?>"><button class="btn btn-primary btn-xs" title="Edit Data"><i class="icon-pencil"></i></button></a>
                                    <a onclick="hapusData(<?php echo $pembelian_id; ?>)"><button class="btn btn-danger btn-xs" title="Hapus Data"><i class="icon-trash"></i></button>
                                    </a>
                                </td>
                            </tr>
                            <?php
