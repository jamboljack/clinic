                        ...
                        <div class="invoice">
                            <div class="row invoice-logo">
                                ...
                                <p>
                                    ...
                                    <span class="muted">No. LPB : <b><?php echo $detail->pembelian_no_lpb.' / '.$detail->pembelian_no_invoice; ?> / <?php echo $date; ?></b></span>
                                </p>
                                </div>
                            </div>
                            <hr/>
                                    ...
                                    <table class="table table-hover table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <button type="button" class="btn btn-primary btn-xs edit_item" data-toggle="modal" data-target="#edititem" data-id="<?php echo $i->detail_id; ?>" data-code="<?php echo $i->obat_code; ?>" data-name="<?php echo $i->detail_name; ?>" data-qty="<?php echo $i->detail_qty; ?>" data-satuan="<?php echo $i->detail_satuan; ?>" data-harga="<?php echo number_format($i->detail_harga, 0, '.', ','); ?>" data-disc="<?php echo $i->detail_disc; ?>" data-subtotal="<?php echo number_format($i->detail_total, 0, '.', ','); ?>" title="Edit Data"><i class="icon-pencil"></i>
                                                    </button>
