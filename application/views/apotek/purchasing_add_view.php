...
<script>
    function hapusDataItem(purc_detail_id) {
        ...
        swal({
            ...
            window.location.href="<?php echo site_url('apotek/purchasing/deletedataitem/'.$this->uri->segment(4)); ?>"+"/"+id
        });
    }
</script>
...
<div class="modal bs-modal-lg" id="edititem" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?php echo site_url('apotek/purchasing/updatedataitem/'.$this->uri->segment(4)); ?>" class="form-horizontal" method="post" enctype="multipart/form-data" role="form" name="form2">
                    ...
                    <div class="row">                
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-5">                                                
                                    <input class="form-control form-control-inline input-medium date-picker" size="16" type="text" name="date" value="<?php echo date('d-m-Y'); ?>" placeholder="DD-MM-YYYY" autocomplete="off" readonly />
                                    <div class="form-control-focus"></div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="portlet-body form">                        
                        <div class="invoice">
                            <div class="row invoice-logo">
                                ...
                                <span class="muted">No. Purchase : <b><?php echo $KodePO; ?> / <?php echo date('d-m-Y'); ?></b></span>
                                </p>
                                </div>
                            </div>
                            <hr/>
                ...
                <div class="portlet light bordered">
                    <div class="portlet-body form">
                        <form role="form" action="<?php echo site_url('apotek/purchasing/savedataitem/'.$this->uri->segment(4)); ?>" method="post" enctype="multipart/form-data" name="form1">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                        <input type="hidden" name="no_purchase" value="<?php echo $KodePO; ?>">
