                    ...
                    <div class="row">                
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">                                                
                                    <input type="text" class="form-control" name="no_faktur" value="<?php echo set_value('no_faktur'); ?>" placeholder="Enter No. Faktur" autocomplete="off" required>
                                    <div class="form-control-focus"></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-5">
                                    <input class="form-control form-control-inline input-medium date-picker" size="16" type="text" name="tgl_jatuh_tempo" value="<?php echo date('d-m-Y'); ?>" placeholder="DD-MM-YYYY" autocomplete="off" required />
                                    <div class="form-control-focus"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">                
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-5">
                                    <input type="text" class="form-control" name="address" id="address" value="<?php echo set_value('address'); ?>" placeholder="Enter Alamat" autocomplete="off" readonly>
                                    <div class="form-control-focus"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">                
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="no_pajak" value="<?php echo set_value('no_pajak'); ?>" placeholder="Enter No. Faktur Pajak" autocomplete="off">
                                    <div class="form-control-focus"></div> 
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-5">
                                    <input class="form-control form-control-inline input-medium date-picker" size="16" type="text" name="tgl_pajak" value="<?php echo set_value('tgl_pajak'); ?>" placeholder="DD-MM-YYYY" autocomplete="off"/>
                                    <div class="form-control-focus"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-md-line-input">
                                ...
                                <div class="col-md-2">
                                    <input type="text" class="form-control" name="ppn" id="ppn" value="<?php echo set_value('ppn', 0.00); ?>" onkeydown="HitungTotalNetto()" autocomplete="off">
                                    <div class="form-control-focus"></div>
                                </div>
                            </div>
                        </div>                        
                                    ...
                                    <table class="table table-hover table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <button type="button" class="btn btn-primary btn-xs edit_item" data-toggle="modal" data-target="#edititem" data-id="<?php echo $i->detail_id; ?>" data-code="<?php echo $i->obat_code; ?>" data-name="<?php echo $i->detail_name; ?>" data-qty="<?php echo $i->detail_qty; ?>" data-satuan="<?php echo $i->detail_satuan; ?>" data-harga="<?php echo number_format($i->detail_harga, 0, '.', ','); ?>" data-disc="<?php echo $i->detail_disc; ?>" data-subtotal="<?php echo number_format($i->detail_total, 0, '.', ','); ?>" data-expired="<?php echo $date_ex; ?>" title="Edit Data"><i class="icon-pencil"></i>
                                                    </button>
